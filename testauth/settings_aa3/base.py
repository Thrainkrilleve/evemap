...
SECRET_KEY = os.environ.get("AA_SECRET_KEY", "fallback-secret-key")
...
# Ensure CSRF trusted origins include the site URL if provided.
CSRF_TRUSTED_ORIGINS = [os.getenv("SITE_URL", "https://example.com")]
ALLOWED_HOSTS = ["*"]
DATABASES = {
    "default": {
